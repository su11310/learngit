...
//#define PROGRAM_FLASH_END_ADRESS (0x9D000000+0x7B000-1)//(0x9D000000+BMXPFMSZ-1)
#define PROGRAM_FLASH_END_ADRESS (0x9D000000+0x7E000-1)//(0x9D000000+BMXPFMSZ-1)
...
extern void Blink_Disp(UINT8 Count);
